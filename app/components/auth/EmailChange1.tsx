...
export default function Stage1ChangeEmail() {
  // хедер
  ...
  const handleSubmit = () => {
    ...
    console.log("OK — можна переходити далі");
  };
  ...
  return (
    <div className="min-h-screen bg-green-50 flex flex-col font-sans md:bg-[url('/icons/bg-desktop.png')] bg-[url('/icons/bg-mobile.png')] overflow-x-hidden">
      ...
      <main
        className="
          ...
          w-[90vw] max-w-[850px] min-h-[420px]
      ...
      >
        ...
        <div className="relative z-10 w-full text-left flex justify-center mt-2 sm:mt-4">
          <div className="w-full max-w-[800px]">
            ...
            <div className="relative w-full mt-3">
              ...
              >
                <img
                  src={showPass ? "/icons/Preview-close.png" : "/icons/Preview-open.png"}
                  className="w-5 h-5"
                  alt="toggle"
                />
              </button>
        ...
        <div className="absolute bottom-0 left-0 right-0 rounded-b-xl overflow-hidden pointer-events-none">
          <img
            src="/icons/waves.png"
            alt="Waves"
