...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f1f1e6] font-sans text-[#2d4a22]">
      ...
      <section className="relative px-10 py-20 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2 space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">
            Лелека — <br />
            <span className="text-[#68a347]">
              український месенджер, що об'єднує
            </span>
          </h1>
          <div className="flex flex-col gap-4 max-w-xs">
            <button
              onClick={() => navigate('/register')}
              className="bg-[#7ba35a] text-white py-3 rounded-xl font-bold text-xl shadow-md hover:bg-[#6a8d4d]"
            >
              Зареєструватися
            </button>
            <button
      ...
      <section
        id="about"
        className="mx-10 my-10 bg-[#b8d5a6]/50 rounded-[40px] p-12 flex flex-col md:flex-row items-center gap-10"
      >
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <p className="text-2xl font-bold leading-relaxed">
            Лелека — український месенджер для швидкого, безпечного та зручного
            спілкування.
          </p>
          <p className="text-xl">
            Залишайтесь на зв'язку з рідними та друзями — без підтримки
            іноземних платформ
          </p>
      ...
      <section id="benefits" className="px-10 py-20 text-center">
        ...
        <div className="bg-transparent border-4 border-[#7ba35a] rounded-[50px] p-10 grid grid-cols-1 md:grid-cols-5 gap-4">
          {[
            ...
            <div
              key={idx}
              className="bg-[#7ba35a] p-6 rounded-[30px] text-white flex flex-col items-center justify-center space-y-4"
            >
              <img
                src={item.icon}
                alt={item.title}
      ...
      <section
        id="app"
        className="px-10 py-20 bg-[#c7dfb6] relative overflow-hidden"
      >
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          ...
          <p className="text-xl font-medium">
            Лелека доступний у вебверсії та як застосунок — обирай формат, який
            тобі зручніший <br />
          ...
          {faqItems.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`mt-4 text-sm transition-all overflow-hidden ${
      ...
      <section
        id="contacts"
        className="px-10 py-20 flex flex-col md:flex-row items-center gap-12"
      >
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <p className="text-2xl font-bold text-[#4c7d32]">
      ...
      <footer className="bg-[#b8d5a6] px-10 py-10 flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <a
          ...
          className="text-xl font-bold underline decoration-2"
        >
